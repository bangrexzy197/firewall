...
echo -e "${CYAN}┌──────────────────────────────────────────────┐${NC}"
echo -e "${CYAN}│${NC} ${YELLOW}Firewall Status:${NC} ${GREEN}ACTIVE${NC}           "
echo -e "${CYAN}│${NC} ${YELLOW}Rate Limit:${NC}      ${WHITE}30 req/sec${NC}       "
echo -e "${CYAN}│${NC} ${YELLOW}Fail2ban:${NC}        ${WHITE}Active${NC}           "
echo -e "${CYAN}└──────────────────────────────────────────────┘${NC}\n"
